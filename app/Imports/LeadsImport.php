...
class LeadsImport implements ToCollection, WithValidation, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    ...
    public function rules(): array
    {
        return [
            ...
            'lead_source' => 'nullable|in:Google,Indiamart,Justdial,Instagram,Facebook,Self,Referral,Channel Partner,Other',
    ...
    public function customValidationMessages()
    {
        return [
            ...
            'lead_source.in' => 'The lead source must be one of: Google, Indiamart, Justdial, Instagram, Facebook, Referral, Channel Partner, Other, Self.',
